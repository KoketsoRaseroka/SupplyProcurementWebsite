...
$meta_title="K-DAISY TRADING AND PROJECTS";
$meta_desc="@K-DAISY TRADING AND PROJECTS' Official Website";
$meta_keyword="K-DAISY TRADING AND PROJECTS";
                ...
                <div class="container">
                    <div class="row">
						...
						<div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.php"><img src="images/logo/mylogo.png" alt="logo images"></a>
                                </div>
                            </div>
