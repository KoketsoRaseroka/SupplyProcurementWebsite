...
if(isset($_POST['submit'])){
	$categories_id=get_svalue($con,$_POST['categories_id']);
	$sub_categories_id=get_svalue($con,$_POST['sub_categories_id']);
	$name=get_svalue($con,$_POST['name']);
	$mrp=get_svalue($con,$_POST['mrp']);
	$price=get_svalue($con,$_POST['price']);
	$qty=get_svalue($con,$_POST['qty']);
	$short_desc=get_svalue($con,$_POST['short_desc']);
	$description=get_svalue($con,$_POST['description']);
	$meta_title=get_svalue($con,$_POST['meta_title']);
	$meta_desc=get_svalue($con,$_POST['meta_desc']);
	$meta_keyword=get_svalue($con,$_POST['meta_keyword']);
	$best_seller=get_svalue($con,$_POST['best_seller']);
