...
if(isset($_POST['submit'])){
     $username=get_svalue($con,$_POST['username']);
	 $password=get_svalue($con,$_POST['password']);
    ...
    if($count>0){
		...
		$msg="Please enter the correct login credentials";	
	}
}
?>
<!doctype html>
<html class="no-js" lang="">
   ...
   <head>
      ...
      <link rel="stylesheet" href="cthemify-icons.css">
      <link rel="stylesheet" href="pe-icon-7-filled.css">
   ...
   <body class="bg-dark">
      ...
      <script src="resources\js\vendor\jquery-2.1.4.min.js" type="text/javascript"></script>
